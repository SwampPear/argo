  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.pageSelectionContainer}>
        <button className={styles.pageSelectionButton} onClick={handleStartBrowser} title="Run">
        ...
        <button className={styles.pageSelectionButton} onClick={() => setPage('log')} title="Logs">
          <svg xmlns="http://www.w3.org/2000/svg" className={styles.pageSelectionButtonIcon} viewBox="0 0 16 16">
